...
export const 主将装备宝石属性按部位 = {
  ...
  武器: ['攻击', '命中率', '暴击率', '致命率', '暴击力', '穿透率', '法爆率', '爆伤力', '法伤力', '法穿率'],
  护腕: ['力量', '气血', '攻击', '暴击率', '致命率', '暴击力', '穿透率', '法爆率', '法穿率'],
  铠甲: [
    '体质',
    '力量',
    '防御',
...
/** 主将今世职业基础属性（docs/私有文档/职业加成.md「主将今世」）；连击数区间 2～3 */
const 主将职业原始战斗属性表 = {
  武: {
    命中率: 85,
    暴击率: 15,
 ...
 * **速度** 的异人 +0.5% 见 `主将前世槽速度连乘系数`：主将在装备坐骑等加算之后再乘面板速度；副将在「仅五维」步对速基直接乘（当前无额外速度加算项，先后与主将等价）。
 */
const 前世槽攻击乘 = 1.1
const 前世槽气血乘 = 1.1
const 前世槽异速度乘 = 1.005
