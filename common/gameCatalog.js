...
/** 展示与战斗计算均保留一位小数的技能「当前效果」 */
const 技能当前效果一位小数 = new Set([
  '力劈华山', '排山倒海', '固若金汤', '凌波微步', '画地为牢', '趁火打劫', '四面楚歌', '金蝉脱壳', '暗渡陈仓',
])

function 技能效果保留一位小数(x) {
...
function 技能当前效果增幅值(名称, base, 战斗属性, 上下文 = {}) {
  ...
  if (技能当前效果一位小数.has(名称) && Number.isFinite(v)) return 技能效果保留一位小数(v)
  return v
}
